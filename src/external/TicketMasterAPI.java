...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "myKqrGvItCCT8fCQfekaWC4FwMDMbIPD"; // haha hard coded key
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			keyword = URLEncoder.encode(keyword, "UTF-8"); // "ni hao" => "ni%20hao"
	...
	public static void main(String[] args) {
		TicketMasterAPI a = new TicketMasterAPI();

//		System.out.println(encodeGeohash(57.64911, 10.40744, 12));
		a.queryAPI(57.64911, 10.40744);
	}
